...
export type CreateTodoComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<CreateTodoMutation, CreateTodoMutationVariables>, 'mutation'>;

    export const CreateTodoComponent = (props: CreateTodoComponentProps) => (
      <ApolloReactComponents.Mutation<CreateTodoMutation, CreateTodoMutationVariables> mutation={CreateTodoDocument} {...props} />
    );
...
export type DestroyTodoComponentProps = Omit<ApolloReactComponents.MutationComponentOptions<DestroyTodoMutation, DestroyTodoMutationVariables>, 'mutation'>;

    export const DestroyTodoComponent = (props: DestroyTodoComponentProps) => (
      <ApolloReactComponents.Mutation<DestroyTodoMutation, DestroyTodoMutationVariables> mutation={DestroyTodoDocument} {...props} />
    );
    
export type DestroyTodoProps<TChildProps = {}> = ApolloReactHoc.MutateProps<DestroyTodoMutation, DestroyTodoMutationVariables> & TChildProps;
export function withDestroyTodo<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  DestroyTodoMutation,
  DestroyTodoMutationVariables,
  DestroyTodoProps<TChildProps>>) {
    return ApolloReactHoc.withMutation<TProps, DestroyTodoMutation, DestroyTodoMutationVariables, DestroyTodoProps<TChildProps>>(DestroyTodoDocument, {
      alias: 'destroyTodo',
      ...operationOptions
    });
};
